# Plans F–I — Post–Phase-1 (outline index)
...
**Hiện tại:** Plan E code+docs DONE ([DoD](./plan-e-dod-evidence.md), paid AMBER); Plan F DONE ([DoD](./plan-f-dod-evidence.md)). **Next = write Plan G JIT plan.**
...
| Plan | Waves | Outcome | Write full plan when |
|------|-------|---------|----------------------|
...
| **G** | Phase 3: 3A–3F | Ads, attribution, advisor, calendar, public API | **NEXT:** write JIT full plan before code |
