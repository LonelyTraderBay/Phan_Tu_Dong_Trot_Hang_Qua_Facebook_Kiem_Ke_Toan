...
| I5 Public subprocessors | GREEN/AMBER | Public page `/legal/subprocessors`; source `docs/legal/subprocessors.md`. **Eng process template GREEN/AMBER:** [subprocessors-change-notify.md](../../runbooks/subprocessors-change-notify.md) (email/in-app draft + checklist + approval gate). **Legal/owner approve still AMBER** — no invented approval, no claim customers were notified. **Not** I5 full GREEN; **not** E100. |
...
- I5 eng notify process (SDD E5 Task 4, 2026-07-26): runbook/templates landed; legal/owner gate remains AMBER — **not** I5 full GREEN.
